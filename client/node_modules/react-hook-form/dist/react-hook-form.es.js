...
var getRadioValue = (options) => options && Array.isArray(options)
...
var getFieldsValues = (fields) => Object.values(fields).reduce((previous, { ref, ref: { name } }) => (Object.assign({}, previous, { [name]: getFieldValue(fields, ref) })), {});
...
function useForm({ mode = VALIDATION_MODE.onSubmit, validationSchema, defaultValues = {}, validationFields, nativeValidation, submitFocusError = true, validationSchemaOption = { abortEarly: false }, } = {}) {
    ...
    const validateWithSchemaCurry = useCallback(validateWithSchema.bind(null, validationSchema, validationSchemaOption), []);
    ...
    function registerIntoFieldsRef(ref, validateOptions = {}) {
        ...
        if (!type) {
            ...
            if (isRadio) {
                ...
                fields[name] = Object.assign({}, fields[name], validateOptions);
                ...
                fields[name] = Object.assign({}, fieldAttributes, { mutationWatcher });
            }
        }
    ...
    return {
        ...
        errors: validationFields
            ? Object.keys(errorsRef.current).reduce((previous, key) => (Object.assign({}, previous, (validationFields.includes(key)
                ? { [key]: errorsRef.current[key] }
                : null))), {})
            : errorsRef.current,
        formState: Object.assign({ dirty: isDirtyRef.current, isSubmitted: isSubmittedRef.current, submitCount, touched: [...touchedFieldsRef.current], isSubmitting }, (isOnSubmit
            ? {
...
function FormContext(props) {
    ...
    return (createElement(FormGlobalContext.Provider, { value: rest }, children));
}
