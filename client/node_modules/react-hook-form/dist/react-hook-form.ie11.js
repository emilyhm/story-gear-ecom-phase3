...
var combineFieldValues = (function (data) {
    return Object.entries(data).reduce(function (previous, _a) {
        ...
        return __assign({}, previous, (_b = {}, _b[key] = value, _b));
    }, {});
});
...
var getFieldsValues = (function (fields) {
    return Object.values(fields).reduce(function (previous, _a) {
        ...
        return (__assign({}, previous, (_b = {}, _b[name] = getFieldValue(fields, ref), _b)));
    }, {});
});
...
var validateField = (function (_a, fields, nativeValidation) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        var error, isRadio, isCheckBox, isSelectOrInput, nativeError, exceedMax, exceedMin, _c, maxValue, maxMessage, _d, minValue, minMessage, valueNumber, message, _e, maxLengthValue, maxLengthMessage, _f, minLengthValue, minLengthMessage, inputLength, exceedMax, exceedMin, message, _g, patternValue, patternMessage, fieldValue_1, validateRef_1, result, isStringValue, message, validationResult;
        var _this = this;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 1:
                    result = _h.sent();
                    isStringValue = isString(result);
                    if (isStringValue || (isBoolean(result) && !result)) {
                        message = isStringValue ? result : '';
                        error[name] = {
                            type: 'validate',
                            message: message,
                            ref: validateRef_1,
                ...
                case 2:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve) {
                            ...
                            values.reduce(function (previous, _a, index) {
                                ...
                                return __awaiter(_this, void 0, void 0, function () {
                                    var lastChild, result, isStringValue, message, data;
...
function parseErrorSchema(error) {
    return error.inner.reduce(function (previous, _a) {
        ...
        return (__assign({}, previous, (_b = {}, _b[path] = { message: message, ref: {}, type: type }, _b)));
    }, {});
}
...
var assignWatchFields = (function (fieldValues, fieldName, watchFields) {
    if (isUndefined(fieldValues) || isEmptyObject(fieldValues))
        return undefined;
...
var omitValidFields = (function (errorFields, validFieldNames) {
    return Object.entries(errorFields).reduce(function (previous, _a) {
        ...
        return validFieldNames.some(function (validFieldName) { return validFieldName === name; })
            ? previous
            : __assign({}, previous, (_b = {}, _b[name] = error, _b));
    }, {});
});
...
function useForm(_a) {
    ...
    var _g = __read(React.useState(false), 2), isSubmitting = _g[0], setIsSubmitting = _g[1];
    var _h = __read(React.useState(0), 2), submitCount = _h[0], setSubmitCount = _h[1];
    var _j = __read(React.useState({}), 2), reRenderForm = _j[1];
    var _k = React.useRef(modeChecker(mode)).current, isOnBlur = _k.isOnBlur, isOnSubmit = _k.isOnSubmit;
    ...
    var combineErrorsRef = function (data) { return (__assign({}, errorsRef.current, data)); };
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    errorsRef.current = omitValidFields(combineErrorsRef(Object.entries(fieldErrors)
                        ...
                        var _b;
                        var _c = __read(_a, 2), name = _c[0], error = _c[1];
                        return (__assign({}, previous, (_b = {}, _b[name] = error, _b)));
                    }, {})), validFieldNames);
    ...
    validateAndUpdateStateRef.current = validateAndUpdateStateRef.current
        ...
        : function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var fields, errors, ref, error, isBlurEvent, isValidateDisabled, shouldUpdateState, fieldErrors, shouldUpdate;
                var _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
    ...
    function watch(fieldNames, defaultValue) {
        ...
        if (isArray$1(fieldNames)) {
            return fieldNames.reduce(function (previous, name) {
                ...
                return __assign({}, previous, (_a = {}, _a[name] = value, _a));
            }, {});
        }
    ...
    function registerIntoFieldsRef(ref, validateOptions) {
        ...
        if (!type) {
            ...
            if (isRadio) {
                ...
                fields[name] = __assign({}, fields[name], validateOptions);
                ...
                fields[name] = __assign({}, fieldAttributes, { mutationWatcher: mutationWatcher });
            }
        }
                            ...
                            switch (_b.label) {
                                ...
                                case 2:
                                    ...
                                    if (fieldError[name]) {
                                        ...
                                        resolvedPrevious.errors = __assign({}, resolvedPrevious.errors, fieldError);
                                        validFieldsRef.current.delete(name);
                                        return [2 /*return*/, Promise.resolve(resolvedPrevious)];
                                    }
                                    if (fieldsWithValidationRef.current.has(name))
    ...
    return {
        ...
        errors: validationFields
            ? Object.keys(errorsRef.current).reduce(function (previous, key) {
                var _a;
                return (__assign({}, previous, (validationFields.includes(key)
                    ? (_a = {}, _a[key] = errorsRef.current[key], _a) : null)));
            }, {})
            : errorsRef.current,
        formState: __assign({ dirty: isDirtyRef.current, isSubmitted: isSubmittedRef.current, submitCount: submitCount, touched: __spread(touchedFieldsRef.current), isSubmitting: isSubmitting }, (isOnSubmit
            ? {
